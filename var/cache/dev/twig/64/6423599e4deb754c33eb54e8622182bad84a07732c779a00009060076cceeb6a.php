...
class __TwigTemplate_0728627942b807551779042c37fc6fd67857dfd4288ce9b40a6f67fed1ed27f3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  113 => 17,  105 => 11,  96 => 8,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container\" style=\"width: 1000px\">
        ...
        <div style=\"width: 1000px; text-align: center\" >
            <a href=\"tel:0624426009\" class=\"btn btn-secondary btn-lg\" style=\"border-radius: 20px\">Téléphone</a>
            <a href=\"{{ path('contact/newMail') }}\" class=\"btn btn-secondary btn-lg\" style=\"border-radius: 20px\">Mail</a>
        </div>
        <div style=\"margin-bottom: 30px\"></div>
        <div class=\"col-6\" style=\"border: 10px white;\">
            <iframe id=\"map\"
...
{% endblock %}
", "contact/contact.html.twig", "C:\\wamp64\\www\\site_Llanas\\templates\\contact\\contact.html.twig");
    }
}
