...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\AdminArtworkController' => 'getAdminArtworkControllerService',
            'App\\Controller\\ArtworksController' => 'getArtworksControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.artworks' => 'getUniqidNamer_ArtworksService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'\\src\\Services\\ImageSize.php';
    ...
    /**
     * Gets the public 'App\Controller\AdminArtworkController' shared autowired service.
     *
     * @return \App\Controller\AdminArtworkController
     */
    protected function getAdminArtworkControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\AdminArtworkController.php';

        $this->services['App\\Controller\\AdminArtworkController'] = $instance = new \App\Controller\AdminArtworkController(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Repository\\ArtworkRepository'] ?? $this->getArtworkRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\AdminArtworkController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\ArtworksController' shared autowired service.
     *
     * @return \App\Controller\ArtworksController
     */
    protected function getArtworksControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\ArtworksController.php';

        $this->services['App\\Controller\\ArtworksController'] = $instance = new \App\Controller\ArtworksController(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Repository\\ArtworkRepository'] ?? $this->getArtworkRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\ArtworksController', $this));
    ...
    protected function getContactControllerService()
    {
        ...
        $this->services['App\\Controller\\ContactController'] = $instance = new \App\Controller\ContactController(($this->services['twig'] ?? $this->getTwigService()));
    ...
    protected function getHomeControllerService()
    {
        ...
        $this->services['App\\Controller\\HomeController'] = $instance = new \App\Controller\HomeController(($this->services['twig'] ?? $this->getTwigService()));
    ...
    protected function getNewsControllerService()
    {
        ...
        $this->services['App\\Controller\\NewsController'] = $instance = new \App\Controller\NewsController(($this->services['twig'] ?? $this->getTwigService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\NewsController', $this));
    ...
    protected function getSecurityControllerService()
    {
        ...
        $this->services['App\\Controller\\SecurityController'] = $instance = new \App\Controller\SecurityController(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
     ...
     */
    protected function getWorkshopControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\WorkshopController.php';

        $this->services['App\\Controller\\WorkshopController'] = $instance = new \App\Controller\WorkshopController(($this->services['twig'] ?? $this->getTwigService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\WorkshopController', $this));
    ...
    protected function getCurrentDateTimeDirectoryNamerService()
    {
        ...
        return $this->services['Vich\\UploaderBundle\\Naming\\CurrentDateTimeDirectoryNamer'] = new \Vich\UploaderBundle\Naming\CurrentDateTimeDirectoryNamer(($this->privates['vich_uploader.current_date_time_helper'] ?? ($this->privates['vich_uploader.current_date_time_helper'] = new \Vich\UploaderBundle\Naming\CurrentDateTimeHelper())), ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()));
    }
    ...
    /**
     * Gets the public 'Vich\UploaderBundle\Naming\UniqidNamer.artworks' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getUniqidNamer_ArtworksService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\vich\\uploader-bundle\\src\\Naming\\NamerInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\vich\\uploader-bundle\\src\\Naming\\Polyfill\\FileExtensionTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\vich\\uploader-bundle\\src\\Naming\\UniqidNamer.php';

        return $this->services['Vich\\UploaderBundle\\Naming\\UniqidNamer.artworks'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 7), true, ($this->targetDir.''.'/App_KernelTestDebugContainerDeprecations.log'));
    }
    ...
    protected function getLiipImagine_Config_StackCollectionService()
    {
        ...
        return $this->services['liip_imagine.config.stack_collection'] = new \Liip\ImagineBundle\Config\StackCollection(($this->privates['liip_imagine.config.stack_builder'] ?? $this->getLiipImagine_Config_StackBuilderService()), $this->parameters['liip_imagine.filter_sets']);
    }
    ...
    protected function getLiipImagine_Filter_ManagerService()
    {
        ...
        $instance->addLoader('paste_image', ($this->privates['liip_imagine.filter.loader.paste_image'] ?? $this->getLiipImagine_Filter_Loader_PasteImageService()));
        $instance->addLoader('watermark_image', ($this->privates['liip_imagine.filter.loader.watermark_image'] ?? $this->getLiipImagine_Filter_Loader_WatermarkImageService()));
        $instance->addLoader('background', ($this->privates['liip_imagine.filter.loader.background'] ?? $this->getLiipImagine_Filter_Loader_BackgroundService()));
        ...
        $instance->addPostProcessor('jpegoptim', ($this->privates['liip_imagine.filter.post_processor.jpegoptim'] ?? $this->getLiipImagine_Filter_PostProcessor_JpegoptimService()));
        $instance->addPostProcessor('optipng', ($this->privates['liip_imagine.filter.post_processor.optipng'] ?? $this->getLiipImagine_Filter_PostProcessor_OptipngService()));
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\ArtworkType' => ['privates', 'App\\Form\\ArtworkType', 'getArtworkTypeService', false],
            'App\\Form\\ContactType' => ['privates', 'App\\Form\\ContactType', 'getContactTypeService', false],
            'App\\Notification\\ContactNotification' => ['privates', 'App\\Notification\\ContactNotification', 'getContactNotificationService', false],
            'App\\Repository\\ArtworkRepository' => ['privates', 'App\\Repository\\ArtworkRepository', 'getArtworkRepositoryService', false],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', false],
            'App\\Services\\ImageSize' => ['privates', 'App\\Services\\ImageSize', 'getImageSizeService', false],
            ...
            'Liip\\ImagineBundle\\Config\\FilterFactoryCollection' => ['privates', 'liip_imagine.config.filter_factory_collection', 'getLiipImagine_Config_FilterFactoryCollectionService', false],
            'Liip\\ImagineBundle\\Config\\StackBuilder' => ['privates', 'liip_imagine.config.stack_builder', 'getLiipImagine_Config_StackBuilderService', false],
            'Liip\\ImagineBundle\\Config\\StackCollection' => ['services', 'liip_imagine.config.stack_collection', 'getLiipImagine_Config_StackCollectionService', false],
            ...
            'Liip\\ImagineBundle\\Imagine\\Data\\DataManager' => ['services', 'liip_imagine.data.manager', 'getLiipImagine_Data_ManagerService', false],
            'Liip\\ImagineBundle\\Imagine\\Filter\\FilterManager' => ['services', 'liip_imagine.filter.manager', 'getLiipImagine_Filter_ManagerService', false],
            ...
            'Symfony\\Component\\Security\\Core\\User\\UserProviderInterface' => ['privates', 'security.user.provider.concrete.from_database', 'getSecurity_User_Provider_Concrete_FromDatabaseService', false],
            ...
            'Vich\\UploaderBundle\\Util\\Transliterator' => ['privates', 'Vich\\UploaderBundle\\Util\\Transliterator', 'getTransliteratorService', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.K1Vc0B_', 'get_ServiceLocator_K1Vc0BService', false],
            ...
            'liip_imagine' => ['privates', 'liip_imagine.gd', 'getLiipImagine_GdService', false],
            'liip_imagine.binary.mime_type_guesser' => ['privates', 'liip_imagine.binary.mime_type_guesser', 'getLiipImagine_Binary_MimeTypeGuesserService', false],
            'liip_imagine.command.cache_remove' => ['privates', 'liip_imagine.command.cache_remove', 'getLiipImagine_Command_CacheRemoveService', false],
            'liip_imagine.command.cache_resolve' => ['privates', 'liip_imagine.command.cache_resolve', 'getLiipImagine_Command_CacheResolveService', false],
            'liip_imagine.config.filter_factory_collection' => ['privates', 'liip_imagine.config.filter_factory_collection', 'getLiipImagine_Config_FilterFactoryCollectionService', false],
            'liip_imagine.config.stack_builder' => ['privates', 'liip_imagine.config.stack_builder', 'getLiipImagine_Config_StackBuilderService', false],
            'liip_imagine.controller.config' => ['privates', 'liip_imagine.controller.config', 'getLiipImagine_Controller_ConfigService', false],
            'liip_imagine.factory.config.filter.argument.point' => ['privates', 'liip_imagine.factory.config.filter.argument.point', 'getLiipImagine_Factory_Config_Filter_Argument_PointService', false],
            'liip_imagine.factory.config.filter.argument.size' => ['privates', 'liip_imagine.factory.config.filter.argument.size', 'getLiipImagine_Factory_Config_Filter_Argument_SizeService', false],
            'liip_imagine.factory.config.filter.auto_rotate' => ['privates', 'liip_imagine.factory.config.filter.auto_rotate', 'getLiipImagine_Factory_Config_Filter_AutoRotateService', false],
            'liip_imagine.factory.config.filter.background' => ['privates', 'liip_imagine.factory.config.filter.background', 'getLiipImagine_Factory_Config_Filter_BackgroundService', false],
            'liip_imagine.factory.config.filter.crop' => ['privates', 'liip_imagine.factory.config.filter.crop', 'getLiipImagine_Factory_Config_Filter_CropService', false],
            'liip_imagine.factory.config.filter.downscale' => ['privates', 'liip_imagine.factory.config.filter.downscale', 'getLiipImagine_Factory_Config_Filter_DownscaleService', false],
            'liip_imagine.factory.config.filter.flip' => ['privates', 'liip_imagine.factory.config.filter.flip', 'getLiipImagine_Factory_Config_Filter_FlipService', false],
            'liip_imagine.factory.config.filter.grayscale' => ['privates', 'liip_imagine.factory.config.filter.grayscale', 'getLiipImagine_Factory_Config_Filter_GrayscaleService', false],
            'liip_imagine.factory.config.filter.interlace' => ['privates', 'liip_imagine.factory.config.filter.interlace', 'getLiipImagine_Factory_Config_Filter_InterlaceService', false],
            'liip_imagine.factory.config.filter.paste' => ['privates', 'liip_imagine.factory.config.filter.paste', 'getLiipImagine_Factory_Config_Filter_PasteService', false],
            'liip_imagine.factory.config.filter.relative_resize' => ['privates', 'liip_imagine.factory.config.filter.relative_resize', 'getLiipImagine_Factory_Config_Filter_RelativeResizeService', false],
            'liip_imagine.factory.config.filter.resize' => ['privates', 'liip_imagine.factory.config.filter.resize', 'getLiipImagine_Factory_Config_Filter_ResizeService', false],
            'liip_imagine.factory.config.filter.rotate' => ['privates', 'liip_imagine.factory.config.filter.rotate', 'getLiipImagine_Factory_Config_Filter_RotateService', false],
            'liip_imagine.factory.config.filter.scale' => ['privates', 'liip_imagine.factory.config.filter.scale', 'getLiipImagine_Factory_Config_Filter_ScaleService', false],
            'liip_imagine.factory.config.filter.strip' => ['privates', 'liip_imagine.factory.config.filter.strip', 'getLiipImagine_Factory_Config_Filter_StripService', false],
            'liip_imagine.factory.config.filter.thumbnail' => ['privates', 'liip_imagine.factory.config.filter.thumbnail', 'getLiipImagine_Factory_Config_Filter_ThumbnailService', false],
            'liip_imagine.factory.config.filter.upscale' => ['privates', 'liip_imagine.factory.config.filter.upscale', 'getLiipImagine_Factory_Config_Filter_UpscaleService', false],
            'liip_imagine.factory.config.filter.watermark' => ['privates', 'liip_imagine.factory.config.filter.watermark', 'getLiipImagine_Factory_Config_Filter_WatermarkService', false],
            'liip_imagine.factory.config.stack' => ['privates', 'liip_imagine.factory.config.stack', 'getLiipImagine_Factory_Config_StackService', false],
            ...
            'liip_imagine.filter.loader.auto_rotate' => ['privates', 'liip_imagine.filter.loader.auto_rotate', 'getLiipImagine_Filter_Loader_AutoRotateService', false],
            'liip_imagine.filter.loader.background' => ['privates', 'liip_imagine.filter.loader.background', 'getLiipImagine_Filter_Loader_BackgroundService', false],
            'liip_imagine.filter.loader.crop' => ['privates', 'liip_imagine.filter.loader.crop', 'getLiipImagine_Filter_Loader_CropService', false],
            'liip_imagine.filter.loader.paste_image' => ['privates', 'liip_imagine.filter.loader.paste_image', 'getLiipImagine_Filter_Loader_PasteImageService', false],
            'liip_imagine.filter.loader.relative_resize' => ['privates', 'liip_imagine.filter.loader.relative_resize', 'getLiipImagine_Filter_Loader_RelativeResizeService', false],
            'liip_imagine.filter.loader.resize' => ['privates', 'liip_imagine.filter.loader.resize', 'getLiipImagine_Filter_Loader_ResizeService', false],
            'liip_imagine.filter.loader.scale' => ['privates', 'liip_imagine.filter.loader.scale', 'getLiipImagine_Filter_Loader_ScaleService', false],
            'liip_imagine.filter.loader.strip' => ['privates', 'liip_imagine.filter.loader.strip', 'getLiipImagine_Filter_Loader_StripService', false],
            'liip_imagine.filter.loader.thumbnail' => ['privates', 'liip_imagine.filter.loader.thumbnail', 'getLiipImagine_Filter_Loader_ThumbnailService', false],
            'liip_imagine.filter.loader.upscale' => ['privates', 'liip_imagine.filter.loader.upscale', 'getLiipImagine_Filter_Loader_UpscaleService', false],
            'liip_imagine.filter.loader.watermark_image' => ['privates', 'liip_imagine.filter.loader.watermark_image', 'getLiipImagine_Filter_Loader_WatermarkImageService', false],
            'liip_imagine.filter.post_processor.jpegoptim' => ['privates', 'liip_imagine.filter.post_processor.jpegoptim', 'getLiipImagine_Filter_PostProcessor_JpegoptimService', false],
            'liip_imagine.filter.post_processor.mozjpeg' => ['privates', 'liip_imagine.filter.post_processor.mozjpeg', 'getLiipImagine_Filter_PostProcessor_MozjpegService', false],
            'liip_imagine.filter.post_processor.optipng' => ['privates', 'liip_imagine.filter.post_processor.optipng', 'getLiipImagine_Filter_PostProcessor_OptipngService', false],
            'liip_imagine.filter.post_processor.pngquant' => ['privates', 'liip_imagine.filter.post_processor.pngquant', 'getLiipImagine_Filter_PostProcessor_PngquantService', false],
            'liip_imagine.form.type.image' => ['privates', 'liip_imagine.form.type.image', 'getLiipImagine_Form_Type_ImageService', false],
            'liip_imagine.gd' => ['privates', 'liip_imagine.gd', 'getLiipImagine_GdService', false],
            'liip_imagine.meta_data.reader' => ['privates', 'liip_imagine.meta_data.reader', 'getLiipImagine_MetaData_ReaderService', false],
            'liip_imagine.service.filter' => ['privates', 'liip_imagine.service.filter', 'getLiipImagine_Service_FilterService', false],
            ...
            'security.user.provider.concrete.from_database' => ['privates', 'security.user.provider.concrete.from_database', 'getSecurity_User_Provider_Concrete_FromDatabaseService', false],
            ...
            'vich_uploader.command.mapping_debug_class' => ['privates', 'vich_uploader.command.mapping_debug_class', 'getVichUploader_Command_MappingDebugClassService', false],
            'vich_uploader.command.mapping_list_classes' => ['privates', 'vich_uploader.command.mapping_list_classes', 'getVichUploader_Command_MappingListClassesService', false],
            'vich_uploader.current_date_time_helper' => ['privates', 'vich_uploader.current_date_time_helper', 'getVichUploader_CurrentDateTimeHelperService', false],
            'vich_uploader.file_injector' => ['privates', 'vich_uploader.file_injector', 'getVichUploader_FileInjectorService', false],
            'vich_uploader.listener.clean.artworks' => ['privates', 'vich_uploader.listener.clean.artworks', 'getVichUploader_Listener_Clean_ArtworksService', false],
            'vich_uploader.listener.remove.artworks' => ['privates', 'vich_uploader.listener.remove.artworks', 'getVichUploader_Listener_Remove_ArtworksService', false],
            'vich_uploader.listener.upload.artworks' => ['privates', 'vich_uploader.listener.upload.artworks', 'getVichUploader_Listener_Upload_ArtworksService', false],
            ...
            'security.user.provider.concrete.from_database' => '?',
            ...
            'vich_uploader.listener.clean.artworks' => '?',
            'vich_uploader.listener.remove.artworks' => '?',
            'vich_uploader.listener.upload.artworks' => '?',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(($this->privates['App\\Services\\ImageSize'] ?? ($this->privates['App\\Services\\ImageSize'] = new \App\Services\ImageSize())));
    ...
    /**
     * Gets the private '.errored..service_locator.hhe.9nt.App\Entity\Artwork' shared service.
     *
     * @return \App\Entity\Artwork
     */
    protected function getArtworkService()
    {
        include_once \dirname(__DIR__, 4).'\\src\\Entity\\Artwork.php';

        return $this->privates['.errored..service_locator.hhe.9nt.App\\Entity\\Artwork'] = new \App\Entity\Artwork();
    }
    ...
    /**
     * Gets the private '.service_locator.K1Vc0B_' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_K1Vc0BService()
    {
        return $this->privates['.service_locator.K1Vc0B_'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AdminArtworkController::delete' => ['privates', '.service_locator.hhe.9nt', 'get_ServiceLocator_Hhe_9ntService', false],
            'App\\Controller\\AdminArtworkController::index' => ['privates', '.service_locator.CY_hMZh', 'get_ServiceLocator_CYHMZhService', false],
            'App\\Controller\\ArtworksController::getAcrylic' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getDraws' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getInk' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getPastel' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getSticking' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getVarious' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ArtworksController::getWatercolor' => ['privates', '.service_locator.fp38Ze0', 'get_ServiceLocator_Fp38Ze0Service', false],
            'App\\Controller\\ContactController::newMail' => ['privates', '.service_locator.V2y0eKD', 'get_ServiceLocator_V2y0eKDService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.q6jLs_L', 'get_ServiceLocator_Q6jLsLService', false],
        ], [
            'App\\Controller\\AdminArtworkController::delete' => '?',
            'App\\Controller\\AdminArtworkController::index' => '?',
            'App\\Controller\\ArtworksController::getAcrylic' => '?',
            'App\\Controller\\ArtworksController::getDraws' => '?',
            'App\\Controller\\ArtworksController::getInk' => '?',
            'App\\Controller\\ArtworksController::getPastel' => '?',
            'App\\Controller\\ArtworksController::getSticking' => '?',
            'App\\Controller\\ArtworksController::getVarious' => '?',
            'App\\Controller\\ArtworksController::getWatercolor' => '?',
            'App\\Controller\\ContactController::newMail' => '?',
            'App\\Controller\\SecurityController::login' => '?',
        ]);
    }

    /**
     * Gets the private '.service_locator.V2y0eKD' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_V2y0eKDService()
    {
        return $this->privates['.service_locator.V2y0eKD'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.fp38Ze0' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Fp38Ze0Service()
    {
        return $this->privates['.service_locator.fp38Ze0'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'paginator' => ['services', 'knp_paginator', 'getKnpPaginatorService', false],
            'repository' => ['privates', 'App\\Repository\\ArtworkRepository', 'getArtworkRepositoryService', false],
        ], [
            'paginator' => '?',
            'repository' => 'App\\Repository\\ArtworkRepository',
        ]);
    }

    /**
     * Gets the private '.service_locator.hhe.9nt' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Hhe_9ntService()
    {
        return $this->privates['.service_locator.hhe.9nt'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'artwork' => ['privates', '.errored..service_locator.hhe.9nt.App\\Entity\\Artwork', NULL, 'Cannot autowire service ".service_locator.hhe.9nt": it references class "App\\Entity\\Artwork" but no such service exists.'],
        ], [
            'artwork' => 'App\\Entity\\Artwork',
        ]);
    }
    ...
    /**
     * Gets the private 'App\Form\ArtworkType' shared autowired service.
     *
     * @return \App\Form\ArtworkType
     */
    protected function getArtworkTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\ArtworkType.php';

        return $this->privates['App\\Form\\ArtworkType'] = new \App\Form\ArtworkType();
    }
    ...
    protected function getContactNotificationService()
    {
        ...
        return $this->privates['App\\Notification\\ContactNotification'] = new \App\Notification\ContactNotification(($this->services['swiftmailer.mailer.default'] ?? $this->getSwiftmailer_Mailer_DefaultService()), ($this->services['twig'] ?? $this->getTwigService()));
    }
     ...
     */
    protected function getArtworkRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\ArtworkRepository'] = new \App\Repository\ArtworkRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Services\ImageSize' shared autowired service.
     *
     * @return \App\Services\ImageSize
     */
    protected function getImageSizeService()
    {
        return $this->privates['App\\Services\\ImageSize'] = new \App\Services\ImageSize();
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Lkjbw-xw5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('m1Lgt4gO1s', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rEqilt0Bv-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BwyV9hn1GJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VGiuOmGKOm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dlLHC6lS94', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+0cTgx2-dM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedController_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.K1Vc0B_'] ?? $this->get_ServiceLocator_K1Vc0BService()));
    }
    ...
    protected function getDebug_ArgumentResolver_Service_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.service.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(($this->privates['.service_locator.K1Vc0B_'] ?? $this->get_ServiceLocator_K1Vc0BService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.clean.artworks'] ?? $this->getVichUploader_Listener_Clean_ArtworksService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.remove.artworks'] ?? $this->getVichUploader_Listener_Remove_ArtworksService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.upload.artworks'] ?? $this->getVichUploader_Listener_Upload_ArtworksService()));
     ...
     */
    protected function getLiipImagine_Config_FilterFactoryCollectionService()
    {
     ...
     */
    protected function getLiipImagine_Config_StackBuilderService()
    {
     ...
     */
    protected function getLiipImagine_Controller_ConfigService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Config\\Controller\\ControllerConfig.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_Argument_PointService()
    {
    ...
    /**
     * Gets the private 'liip_imagine.factory.config.filter.argument.size' shared service.
     *
     * @return \Liip\ImagineBundle\Factory\Config\Filter\Argument\SizeFactory
     */
    protected function getLiipImagine_Factory_Config_Filter_Argument_SizeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\Argument\\SizeFactory.php';

        return $this->privates['liip_imagine.factory.config.filter.argument.size'] = new \Liip\ImagineBundle\Factory\Config\Filter\Argument\SizeFactory();
    }
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_AutoRotateService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\AutoRotateFactory.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_BackgroundService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_CropService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_DownscaleService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_FlipService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\FlipFactory.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_GrayscaleService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\GrayscaleFactory.php';

        return $this->privates['liip_imagine.factory.config.filter.grayscale'] = new \Liip\ImagineBundle\Factory\Config\Filter\GrayscaleFactory();
    }

    /**
     * Gets the private 'liip_imagine.factory.config.filter.interlace' shared service.
     *
     * @return \Liip\ImagineBundle\Factory\Config\Filter\InterlaceFactory
     */
    protected function getLiipImagine_Factory_Config_Filter_InterlaceService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\InterlaceFactory.php';

        return $this->privates['liip_imagine.factory.config.filter.interlace'] = new \Liip\ImagineBundle\Factory\Config\Filter\InterlaceFactory();
    }
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_PasteService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_RelativeResizeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\RelativeResizeFactory.php';

        return $this->privates['liip_imagine.factory.config.filter.relative_resize'] = new \Liip\ImagineBundle\Factory\Config\Filter\RelativeResizeFactory();
    }
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_ResizeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_RotateService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\RotateFactory.php';

        return $this->privates['liip_imagine.factory.config.filter.rotate'] = new \Liip\ImagineBundle\Factory\Config\Filter\RotateFactory();
    }

    /**
     * Gets the private 'liip_imagine.factory.config.filter.scale' shared service.
     *
     * @return \Liip\ImagineBundle\Factory\Config\Filter\ScaleFactory
     */
    protected function getLiipImagine_Factory_Config_Filter_ScaleService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_StripService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\StripFactory.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_ThumbnailService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_Filter_UpscaleService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
    ...
    /**
     * Gets the private 'liip_imagine.factory.config.filter.watermark' shared service.
     *
     * @return \Liip\ImagineBundle\Factory\Config\Filter\WatermarkFactory
     */
    protected function getLiipImagine_Factory_Config_Filter_WatermarkService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\FilterFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\Filter\\WatermarkFactory.php';
     ...
     */
    protected function getLiipImagine_Factory_Config_StackService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\StackFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\liip\\imagine-bundle\\Factory\\Config\\StackFactory.php';

        return $this->privates['liip_imagine.factory.config.stack'] = new \Liip\ImagineBundle\Factory\Config\StackFactory();
    }
    ...
    protected function getLiipImagine_Filter_Loader_AutoRotateService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.auto_rotate'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\AutoRotateFilterLoader();
    }
    ...
    protected function getLiipImagine_Filter_Loader_BackgroundService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.background'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\BackgroundFilterLoader(($this->privates['liip_imagine.gd'] ?? $this->getLiipImagine_GdService()));
    }
    ...
    protected function getLiipImagine_Filter_Loader_PasteImageService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.paste_image'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader(($this->privates['liip_imagine.gd'] ?? $this->getLiipImagine_GdService()), \dirname(__DIR__, 4));
    }
    ...
    protected function getLiipImagine_Filter_Loader_RelativeResizeService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.relative_resize'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\RelativeResizeFilterLoader();
    }
    ...
    protected function getLiipImagine_Filter_Loader_ResizeService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.resize'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\ResizeFilterLoader();
    }
    ...
    protected function getLiipImagine_Filter_Loader_WatermarkImageService()
    {
        ...
        return $this->privates['liip_imagine.filter.loader.watermark_image'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader(($this->privates['liip_imagine.gd'] ?? $this->getLiipImagine_GdService()), \dirname(__DIR__, 4));
    }
    ...
    protected function getLiipImagine_Filter_PostProcessor_MozjpegService()
    {
        ...
        return $this->privates['liip_imagine.filter.post_processor.mozjpeg'] = new \Liip\ImagineBundle\Imagine\Filter\PostProcessor\MozJpegPostProcessor('/opt/mozjpeg/bin/cjpeg');
    }
    ...
    protected function getLiipImagine_Filter_PostProcessor_PngquantService()
    {
        ...
        return $this->privates['liip_imagine.filter.post_processor.pngquant'] = new \Liip\ImagineBundle\Imagine\Filter\PostProcessor\PngquantPostProcessor('/usr/bin/pngquant');
    }
    ...
    protected function getLiipImagine_GdService()
    {
        ...
        $instance->setMetadataReader(($this->privates['liip_imagine.meta_data.reader'] ?? ($this->privates['liip_imagine.meta_data.reader'] = new \Imagine\Image\Metadata\ExifMetadataReader())));
     ...
     */
    protected function getLiipImagine_MetaData_ReaderService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\imagine\\imagine\\src\\Image\\Metadata\\MetadataReaderInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\imagine\\imagine\\src\\Image\\Metadata\\AbstractMetadataReader.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\imagine\\imagine\\src\\Image\\Metadata\\ExifMetadataReader.php';

        return $this->privates['liip_imagine.meta_data.reader'] = new \Imagine\Image\Metadata\ExifMetadataReader();
    }
    ...
    protected function getSecurity_Authentication_SuccessHandler_Main_FormLoginService()
    {
        ...
        $instance->setOptions(['always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false]);
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\User' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => 12, 3 => 1]]]);
    }
    ...
    protected function getSecurity_Firewall_Map_Config_MainService()
    {
        ...
        return $this->privates['security.firewall.map.config.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.from_database', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, [0 => 'form_login', 1 => 'anonymous'], NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        }, 5), ($this->privates['security.exception_listener.main'] ?? $this->getSecurity_ExceptionListener_MainService()), ($this->privates['security.logout_listener.main'] ?? $this->getSecurity_LogoutListener_MainService()), ($this->privates['security.firewall.map.config.main'] ?? $this->getSecurity_Firewall_Map_Config_MainService()));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_FromDatabaseService()
    {
        ...
        return $this->privates['security.user.provider.concrete.from_database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', 'username', NULL);
    }
     ...
     */
    protected function getVichUploader_CurrentDateTimeHelperService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\vich\\uploader-bundle\\src\\Naming\\DateTimeHelper.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\vich\\uploader-bundle\\src\\Naming\\CurrentDateTimeHelper.php';
    ...
    /**
     * Gets the private 'vich_uploader.listener.clean.artworks' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\CleanListener
     */
    protected function getVichUploader_Listener_Clean_ArtworksService()
    {
        return $this->privates['vich_uploader.listener.clean.artworks'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('artworks', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.remove.artworks' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener
     */
    protected function getVichUploader_Listener_Remove_ArtworksService()
    {
        return $this->privates['vich_uploader.listener.remove.artworks'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('artworks', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.upload.artworks' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\UploadListener
     */
    protected function getVichUploader_Listener_Upload_ArtworksService()
    {
        return $this->privates['vich_uploader.listener.upload.artworks'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('artworks', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'pictures_directory' => (\dirname(__DIR__, 4).'/public/uploads/pictures'),
            ...
            'vich_uploader.mappings' => [
                'artworks' => [
                    'uri_prefix' => '/pics/artworks',
                    'upload_destination' => '../public/pics/artworks',
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.artworks',
                        'options' => [
